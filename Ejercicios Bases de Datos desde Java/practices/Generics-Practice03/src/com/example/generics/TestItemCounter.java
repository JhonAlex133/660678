    ...
    public static void main(String[] args) {
        ...
        for (DukeTransaction transaction : transactions) {
            if (polos.containsKey(transaction.getProductID())) {
                ...
                System.out.println("Error :Parte del número invalido");
            }
            switch(transaction.getTransactionType()){
                case "Purchase": currentShirt.addItems(transaction.getCount());
                    break;
                case "Sale": currentShirt.addItems(transaction.getCount());
                    break;
                default: System.out.println("Error: Tipo de transacción invalida");
                    continue;
            }
        }
        ...
        System.out.println("  === Reporte de inventario - Descripción ===  ");
        ...
        System.out.println(" === Reporte de Inventario - Camisas ===  ");
