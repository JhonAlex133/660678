...
public class CategoriaDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findAll();
		// findWhereIdCategoriaEquals(null);
		// findWhereNombreCategoriaEquals("");
		// findWhereActivaEquals(null);
		// findWhereParienteEquals(null);
	}
	 ...
	 * @param idCategoria
	 */
	public static void findWhereIdCategoriaEquals(Integer idCategoria)
	{
		try {
			CategoriaDao _dao = getCategoriaDao();
	 ...
	 * @param pariente
	 */
	public static void findWhereParienteEquals(Integer pariente)
	{
		try {
			CategoriaDao _dao = getCategoriaDao();
