...
public class PedidoDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findAll();
		// findByFactura(null);
		// findWhereFacturaIdfacturaEquals(null);
		// findWhereTotalEquals(null);
		// findWhereSubtotalEquals(null);
		// findWhereImpuestosEquals(null);
	}
	 ...
	 */
	public static void findByFactura(Integer facturaIdfactura)
	{
		try {
			PedidoDao _dao = getPedidoDao();
	 ...
	 * @param facturaIdfactura
	 */
	public static void findWhereFacturaIdfacturaEquals(Integer facturaIdfactura)
	{
		try {
			PedidoDao _dao = getPedidoDao();
