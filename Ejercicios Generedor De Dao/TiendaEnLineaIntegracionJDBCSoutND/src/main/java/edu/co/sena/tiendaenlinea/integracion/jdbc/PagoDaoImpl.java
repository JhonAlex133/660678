...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	public void update(PagoPk pk, Pago dto) throws PagoDaoException
	{
		...
		try {
			...
			if (pk.getFacturaIdfactura() != null) {
				stmt.setInt( 6, pk.getFacturaIdfactura().intValue() );
			} else {
	 ...
	 */
	public Pago findByPrimaryKey(Integer facturaIdfactura) throws PagoDaoException
	{
		Pago ret[] = findByDynamicSelect( SQL_SELECT + " WHERE Factura_idFactura = ?", new Object[] { facturaIdfactura } );
	 ...
	 * Returns all rows from the pago table that match the criteria 'Factura_idFactura = :facturaIdfactura'.
	 */
	public Pago[] findByFactura(Integer facturaIdfactura) throws PagoDaoException
	{
	 ...
	 * Returns all rows from the pago table that match the criteria 'Factura_idFactura = :facturaIdfactura'.
	 */
	public Pago[] findWhereFacturaIdfacturaEquals(Integer facturaIdfactura) throws PagoDaoException
	{
