...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	public ProductoPk insert(Producto dto) throws ProductoDaoException
	{
		...
		try {
			...
			if (dto.getActivo() != null) {
				stmt.setShort( index++, dto.getActivo().shortValue() );
			} else {
				stmt.setNull(index++, java.sql.Types.SMALLINT);
			}
		
			if (dto.getPrecioUnitario() != null) {
				stmt.setFloat( index++, dto.getPrecioUnitario().floatValue() );
			} else {
				stmt.setNull(index++, java.sql.Types.FLOAT);
			}
		
			if (dto.getDescuento() != null) {
				stmt.setFloat( index++, dto.getDescuento().floatValue() );
			} else {
				stmt.setNull(index++, java.sql.Types.FLOAT);
			}
		
			if (dto.getCategoriaIdcategoria() != null) {
				stmt.setInt( index++, dto.getCategoriaIdcategoria().intValue() );
			} else {
				stmt.setNull(index++, java.sql.Types.INTEGER);
			}
		
			if (dto.getCatalogoIdcatalogo() != null) {
				stmt.setInt( index++, dto.getCatalogoIdcatalogo().intValue() );
			} else {
				stmt.setNull(index++, java.sql.Types.INTEGER);
			}
	 ...
	 */
	public Producto[] findByCatalogo(Integer catalogoIdcatalogo) throws ProductoDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE Catalogo_idCatalogo = ?", new Object[] { catalogoIdcatalogo } );
	}

	/** 
	 * Returns all rows from the producto table that match the criteria 'Categoria_idCategoria = :categoriaIdcategoria'.
	 */
	public Producto[] findByCategoria(Integer categoriaIdcategoria) throws ProductoDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE Categoria_idCategoria = ?", new Object[] { categoriaIdcategoria } );
	}
	 ...
	 */
	public Producto[] findWhereCantidadEquals(Integer cantidad) throws ProductoDaoException
	{
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE precioUnitario = ? ORDER BY precioUnitario", new Object[] { precioUnitario } );
	}
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE descuento = ? ORDER BY descuento", new Object[] { descuento } );
	}

	/** 
	 * Returns all rows from the producto table that match the criteria 'Categoria_idCategoria = :categoriaIdcategoria'.
	 */
	public Producto[] findWhereCategoriaIdcategoriaEquals(Integer categoriaIdcategoria) throws ProductoDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE Categoria_idCategoria = ? ORDER BY Categoria_idCategoria", new Object[] { categoriaIdcategoria } );
	}

	/** 
	 * Returns all rows from the producto table that match the criteria 'Catalogo_idCatalogo = :catalogoIdcatalogo'.
	 */
	public Producto[] findWhereCatalogoIdcatalogoEquals(Integer catalogoIdcatalogo) throws ProductoDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE Catalogo_idCatalogo = ? ORDER BY Catalogo_idCatalogo", new Object[] { catalogoIdcatalogo } );
	}
	...
	protected void populateDto(Producto dto, ResultSet rs) throws SQLException
	{
		...
		dto.setActivo( new Short( rs.getShort(COLUMN_ACTIVO) ) );
		dto.setPrecioUnitario( new Float( rs.getFloat(COLUMN_PRECIO_UNITARIO) ) );
		dto.setDescuento( new Float( rs.getFloat(COLUMN_DESCUENTO) ) );
		dto.setCategoriaIdcategoria( new Integer( rs.getInt(COLUMN_CATEGORIA_IDCATEGORIA) ) );
		dto.setCatalogoIdcatalogo( new Integer( rs.getInt(COLUMN_CATALOGO_IDCATALOGO) ) );
	}
