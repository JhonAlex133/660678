...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	...
	public CarritodecomprasPk insert(Carritodecompras dto) throws CarritodecomprasDaoException
	{
		...
		try {
			...
			if (dto.getPrecioTotal() != null) {
				stmt.setFloat( index++, dto.getPrecioTotal().floatValue() );
			} else {
				stmt.setNull(index++, java.sql.Types.FLOAT);
			}
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE precioTotal = ? ORDER BY precioTotal", new Object[] { precioTotal } );
	}
	...
	protected void populateDto(Carritodecompras dto, ResultSet rs) throws SQLException
	{
		...
		dto.setPrecioTotal( new Float( rs.getFloat(COLUMN_PRECIO_TOTAL) ) );
